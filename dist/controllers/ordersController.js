...
var handleOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var orders, bulkOrderId, isCurrentWorking, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                orders = req.body.orders;
                bulkOrderId = (0, utils_functions_1.randomId)();
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                orders.forEach(function (order) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, OrderDB.create({ bulk_order_id: bulkOrderId, status: "ordered", toppings: order })];
                            case 1:
                                savedOrder = _a.sent();
                                return [4 /*yield*/, (0, utils_functions_1.sleep)(1)
